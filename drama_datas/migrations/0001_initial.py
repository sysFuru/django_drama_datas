# Generated by Django 4.0.4 on 2023-01-06 22:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(max_length=128, verbose_name='国籍')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(verbose_name='放送年')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(max_length=128, verbose_name='国名')),
                ('memo', models.TextField(blank=True, verbose_name='メモ')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='投稿日')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新日')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='投稿者')),
